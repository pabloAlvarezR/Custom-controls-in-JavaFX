...
public class CanvasControl extends Region {
    ...
    public CanvasControl(final String text, final Image image) {
        if (null == image || image.getWidth() != image.getHeight()) {
            this.particleImg = new Image(CanvasControl.class.getResourceAsStream("style/bubble.png"));
        } else {
    ...
    @Override public String getUserAgentStylesheet() {
        if (null == userAgentStyleSheet) { userAgentStyleSheet = CanvasControl.class.getResource("style/canvas.css").toExternalForm(); }
